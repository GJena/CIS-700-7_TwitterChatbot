...
def get_wmt_enfr_train_set(directory):
  ...
  train_path = os.path.join(directory, "dialog")
  # print ("!@#$%^&*(")
  # print (train_path)
  if not (gfile.Exists(train_path +"1.txt") and gfile.Exists(train_path +"2.txt")):
    ...
    print ("Don't have both files")
  else:
    print ("Have both files")  
  return train_path
...
def get_wmt_enfr_dev_set(directory):
  ...
  print (dev_path)
  if not (gfile.Exists(dev_path + "2.txt") and gfile.Exists(dev_path + "1.txt")):
    ...
    print ("Validation data not present")
  else:
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  from_train_path = train_path + "1.txt"
  to_train_path = train_path + "2.txt"
  from_dev_path = dev_path + "1.txt"
  to_dev_path = dev_path + "2.txt"
